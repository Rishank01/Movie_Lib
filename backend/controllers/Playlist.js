...
const Update = async (req, res) => {
    ...
    const newMovie = req.body; // New playlist data with updated movies array
    console.log("PlayList Id : ", playlistId);
    console.log("New Movie : ", newMovie);
    console.log("imdbID :", newMovie.imdbID);
    ...
    try {
        ...
        // Log current state of movies array
        console.log("Current Movies in Playlist:", playlist.movies);

        // Check if the imdbID already exists in the playlist's movies array
